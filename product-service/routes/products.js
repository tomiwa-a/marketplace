...
class ProductRoutes {
  constructor(configContainer) {
    ...
    this.productController = configContainer.getController("product");
  ...
  setupRoutes() {
    ...
    this.router.get(
      "/user/:userId",
      this.productController.listUserProductsController
    );
    ...
    this.router.post(
      "/",
      authenticatedUser,
      this.productController.addProductController
    );
    this.router.patch(
      "/:productId",
